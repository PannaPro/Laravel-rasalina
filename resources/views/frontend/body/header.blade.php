                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="menu__wrap">
                                <nav class="menu__nav">
                                    <div class="logo">
                                        <a href="{{ route('homeSlide')}}" class="logo__black"><img src="{{ asset('frontend/assets/img/logo/logo_black.png')}}" alt=""></a>
                                        <a href="{{ route('homeSlide')}}" class="logo__white"><img src="{{ asset('frontend/assets/img/logo/logo_white.png')}}" alt=""></a>
                                    </div>
