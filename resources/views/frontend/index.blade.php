...
@section('main')
            ...
            <!-- banner-area -->
            @include('frontend.home_all.lending_baner');
            <!-- banner-area-end -->

            <!-- about-area -->
            @include('frontend.home_all.about_section');
    ...
    <a href="services-details.html"><img src="{{ asset('frontendassets/img/images/services_img01.jpg')}}" alt=""></a>
                                </div>
                                <div class="services__content">
                                    <div class="services__icon">
                                        <img class="light" src="{{ asset('frontendassets/img/icons/services_light_icon01.png')}}" alt="">
                                        <img class="dark" src="{{ asset('frontendassets/img/icons/services_icon01.png')}}" alt="">
                                    </div>
            ...
            <!-- portfolio-area -->
            @include('frontend.home_all.portfolio_section')
            <!-- portfolio-area-end -->
            ...
            <!-- blog-area -->
            @include('frontend.home_all.blog_section')
