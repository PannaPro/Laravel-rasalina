                    ...
                    <div class="card-body">
                        ...
                        <div class="p-3">
                            ...
                            @csrf
                                ...
                                Forgot your password? No problem. Just let us know your <strong>E-mail</strong> address and we will email you a password reset link that will allow you to choose a new one.
                                ...
                                <div class="form-group mb-0 row mt-2">
                                    <div class="col-sm-5 mt-3">
                                        <a href="{{ route('login')}}" class="text-muted"><i class="mdi mdi-account-circle"></i> Login Page</a>
                                    </div>
                            </form>
                        </div>
                    </div>
